...
Уравнения траекторий имеют вид $y - x = C\br{y - 3x}^3$ (в неё не входит только $y = 3x$), либо же в параметрической форме $\tsys{& x\br{\tau} = -\tau + C \pow{\tau}{3} \\& y\br{\tau} = -\tau + 3C \pow{\tau}{3}}$.
