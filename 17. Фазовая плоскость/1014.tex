...
$\dfrac {dy} {dx} = \dfrac {-x - 2y - \pow{y}{2}} {y} = \dfrac {-x - 2y + O\br{\pow{y}{2}}} {y}$.
...
$\dfrac {dv} {dt} \bigg| = -\pow{x}{2} - 3\pow{y}{2} - x\pow{y}{2} - 2\pow{y}{3} = -\pow{x}{2} - \pow{y}{2}\br{x + 1} - 2\pow{y}{2}\br{y + 1} < 0$ при $0 < \sqrt{\pow{x}{2} + \pow{y}{2}} < \epsilon_{0} = 1$.
...
Траектории построим при помощи изоклин $x = -\pow{y}{2} - \br{k + 2} y$, представленных на левом графике. График справа содержит решения уравнения без малых возмущений $y\' = \dfrac {-x - 2y} {y}$ -- кривые $y + x = C \exp\br{- \dfrac {x} {y + x}}$. Из графика видно, что в окрестности особой точки такие кривые пренебрежимо мало отличаются от настоящих решений.
