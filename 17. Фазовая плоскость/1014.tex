...
$\der{y}{x} = \dfrac {-x - 2y - \pow{y}{2}\vphantom{O\br{y^2}}} {y}
= \dfrac {-x - 2y + O\br{\pow{y}{2}}} {y}$.

Особой будет лишь точка $M\br{0; 0}$.
Линеаризованное уравнение $\der{y}{x} = \dfrac {-x - 2y} {y}$
имеет матрицу
$A = \begin{pmatrix} 0 & 1 \\ -1 & -2 \end{pmatrix}$
и характеристическое уравнение $\pow{\lambda}{2} + 2\lambda + 1 = 0$, то есть
$\sub{\lambda}{1} = \sub{\lambda}{2} = -1$.
...
$\der{v}{t} \Bigg| = -\pow{x}{2} - 3\pow{y}{2} - x\pow{y}{2} - 2\pow{y}{3}
= -\pow{x}{2} - \pow{y}{2}\br{x + 1} - 2\pow{y}{2}\br{\y + 1} < 0$
при 
$0 < \sqrt{\pow{x}{2} + \pow{y}{2}} < \sub{\epsilon}{0} = 1$.

$A - \lambda E = \begin{pmatrix} 1 & 1 \\ 1 & -1 \end{pmatrix} 
\sim \begin{pmatrix} 1 & 1 \end{pmatrix}$,
$\sub{v}{1} = \begin{pmatrix} 1 \\ -1
\end{pmatrix}$
...
$y\` = \dfrac {-x - 2y} {y}$ -- кривые $y + x = C \exp\br{- \dvfrac {x} {y + x}}$.
Из графика видно, что в окрестности особой точки такие кривые пренебрежимо мало 
