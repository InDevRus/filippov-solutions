...
$$\begin{cases}
        \br{-RLC\omeg\pow{a}{2} + R} a - L\omega b = V \\
        L\omega a + \br{-RLC\omeg\pow{a}{2} + R} b = 0
    \end{cases}$$
\begin{align*}
    \Delta_{0} = \pow{R}{2}\br{1 - LC\omeg\pow{a}{2}}^2 + \br{L\omega}^2 &&
    a = \frac {VR\br{1 - LC\omeg\pow{a}{2}}} {\Delta_{0}} &&
    b = \frac {-VL\omega} {\Delta_{0}} &&
\end{align*}

$$I_{L}\br{t} = \frac{V}{\pow{R}{2}\br{1 - LC\omeg\pow{a}{2}}^2 + \br{L\omega}^2} \br{R\br{1 - LC\omeg\pow{a}{2}} \sin\br{\omega t} - L \cos\br{\omega t}}$$
\begin{equation*}
    \begin{split}
        I_{R}\br{t} = I_{L}\br{t} + LCI\'\'_{L}\br{t} = \frac {V\br{1 - LC\omeg\pow{a}{2}}} {\pow{R}{2}\br{1 - LC\omeg\pow{a}{2}}^2 + \br{L\omega}^2} \br{R \sin\br{\omega t} - \frac {L\omega} {1 - LC\omeg\pow{a}{2}} \cos\br{\omega t}} & \\
        = \frac {V} {\pow{R}{2} + \br{\dfrac {L\omega}{1 - LC\omeg\pow{a}{2}}}^2} \br{R \sin\br{\omega t} - \frac {L\omega} {1 - LC\omeg\pow{a}{2}} \cos\br{\omega t}} & \\
        = \frac {V} {\sqrt{\pow{R}{2} + \br{\dfrac {L\omega}{1 - LC\omeg\pow{a}{2}}}^2}} \sin\br{\omega t - \phi},
    \end{split}
\end{equation*}
где $\phi = \arctg\br{\dfrac{L\omega}{R\br{1 - LC\omeg\pow{a}{2}}}}$.
Амплитуда установившегося режима равняется $A\br{\omega} = \linebreak = \dfrac {V} {\sqrt{\pow{R}{2} + \br{\dfrac {L\omega}{1 - LC\omeg\pow{a}{2}}}^2}}$ и она убывает с возрастанием выражения $\br{\dfrac {L\omega}{1 - LC\omeg\pow{a}{2}}}^2$.
