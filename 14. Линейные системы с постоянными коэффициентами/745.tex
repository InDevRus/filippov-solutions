...
Уравнение $y\'\'\br{x} - 2\br{x - 1} y\'\br{x} + \pow{x}{2} y = 0$ необходимо привести к каноническому виду прежде, чем применять преобразование Лиувилля (пример \textbf{737*}). Это можно сделать, например, заменой

$$y\br{x} = \exp \br{- \frac {1} {2} \tint {p\br{x} dx} } z\br{x} $$

В нашем случае $p\br{x} = -2\br{x - 1}$, $q\br{x} = \pow{x}{2}$ так что заменим

$$y\br{x} = \exp\br{\frac {\br{x - 1}^2} {2}} z\br{x}$$

Инвариант уравнения равен

$$Q_{z\br{x}} \br{x} = q\br{x} - \frac {1} {2} p\'\br{x} - \frac {1} {4} \pow{p}{2}\br{x} = 2x$$
...
$$Q_{z\br{t}}\br{t} = 1 + \ps\pow{i}{3}\br{x} \psi\'\'\br{x} = 1 + \frac {5} {34} \pow{x}{-3} = 1 + O\br{\pow{x}{-3}} = 1 + O\br{\pow{t}{-2}}$$

Следовательно, для фундаментальной системы решений уравнения $z\'\'\br{t} + Q_{z\br{t}} z\br{t} \\ = 0$ получаем следующие оценки:
\begin{align*}
z_{1}\br{t} = \cos\br{t} + O\br{\pow{t}{-1}} \qquad & z_{2}\br{t} = \sin\br{t} + O\br{\pow{t}{-1}}
\end{align*}
...
Итак, оценка фундаментальной системы решений уравнения $y\'\'\br{x} - 2\br{x - 1} y\'\br{x} \\ + \pow{x}{2} y = 0$ такова:
\begin{align*}
