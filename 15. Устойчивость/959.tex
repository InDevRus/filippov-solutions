...
\begin{enumerate}[label={\asbuk*})]
    ...
    $\det\br{C - \rho E} = \rh\pow{o}{2} + \dfrac {\pi} {2} \rho + 1$.
    $2\rh\pow{o}{2} + \pi \rho + 2 = 0$.
    $\rho_{1} = \linebreak = -\dfrac {\pi} {4} - \sqrt{1 - \dfrac {\p\pow{i}{2}} {16}}\ i$.
    $\rho_{2} = -\dfrac {\pi} {4} + \sqrt{1 - \dfrac {\p\pow{i}{2}} {16}}\ i$.
    \vspace{2mm}  $\vbr{\rho_{1}} = \vbr{\rho_{2}} = 1$, и нулевое решение устойчиво, но не асимптотически.
    
    \item $a = \dfrac {1} {2}$, $b = 1$.
    $C = \begin{pmatrix} 0 & -2 \\ \frac {1} {2} & 0 \end{pmatrix}$.
    $\det\br{C - \rho E} = \rh\pow{o}{2} + 1$.
    $\rho_{1} = -i$,
    $\rho_{2} = i$.
    $\vbr{\rho_{1}} = \vbr{\rho_{2}} = 1$, и нулевое решение устойчиво, но не асимптотически.
    ...
    $\det\br{C - \rho E} = \rh\pow{o}{2} + \br{\dfrac {3\pi + 8} {4\sqrt{2}}}\rho + \dfrac {3\pi + 5} {8}$.
    $\rho_{1} = \dfrac {-8 - 3\pi - \sqrt{9\p\pow{i}{2} - 16}} {8\sqrt{2}}$,
    $\rho_{2} = \dfrac {-8 - 3\pi + \sqrt{9\p\pow{i}{2} - 16}} {8\sqrt{2}}$.
    Но $\rho_{1} < \dfrac {-8 - 3 \cdot 3 - \sqrt{9 \cdot \pow{3}{2} - 16}} {8 \cdot 2} \linebreak
    ...
    $\det\br{C - \rho E} = \rh\pow{o}{2}$. $\rho_{1} = \rho_{2} = 0$, и решение асимптотически устойчиво.
\end{enumerate}
