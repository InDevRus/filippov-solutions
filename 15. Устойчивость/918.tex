...
\begin{enumerate}
    ...
    = \linebreak
    = \begin{pmatrix} -2u + \pow{u}{2} - x + o\br{x} + o\br{u} \\ x - u \end{pmatrix}
    = \begin{pmatrix} -2u - x + o\br{\sqrt{\pow{x}{2} + \pow{u}{2}}} \\ x - u \end{pmatrix}
    ...
    = \begin{pmatrix} \ln\br{1 + 4v + \pow{v}{2} - u} \\ u - v \end{pmatrix}
    \linebreak
    = \begin{pmatrix} 4v + \pow{v}{2} - u + o\br{u} + o\br{v} \\ u - v \end{pmatrix}
    = \begin{pmatrix} 4v - u + o\br{\sqrt{\pow{u}{2} + \pow{v}{2}}} \\ u - v \end{pmatrix}
