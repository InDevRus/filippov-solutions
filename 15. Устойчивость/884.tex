...
Докажем по определению неустойчивость. Общее решение равно $X\br{t} = \begin{pmatrix} A \pow{e}{-t} \\ B \pow{e}{t} \end{pmatrix}$. Для $t \ge t_{0} = 0$
\begin{align*}
\br{X\br{t} - \Phi\br{t}}^2 = \pow{A}{2} \pow{e}{-2t} + \pow{B}{2} \pow{e}{2t} &&
\br{X\br{t_{0}} - \Phi\br{t_{0}}}^2 = \pow{A}{2} + \pow{B}{2}
\end{align*}

Для $\epsilon = 1$ и любого $\delta > 0$ потребуем, чтобы $A$ и $B$ были таковы, что $0 < \pow{A}{2} + \pow{B}{2} < \pow{\delta}{2}$. С другой стороны, при
$t \ge \max\br{\ln \dfrac {1} {\vbr{B}}; 0}$ имеем 
$\pow{A}{2} \pow{e}{-2t} + \pow{B}{2} \pow{e}{2t} \ge \pow{B}{2} \pow{e}{2t} \ge 1 = \pow{\epsilon}{2}$, поэтому решение неустойчиво.
