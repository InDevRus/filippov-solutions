...
Тот факт, что
$x\br{t} y\br{t} = O\br{\pow{x}{2}\br{t} + \pow{y}{2}\br{t}} = O\br{o\br{\sqrt{\pow{x}{2}\br{t} + \pow{y}{2}\br{t}}}} = o\br{\vbr{X}}$ при $\vbr{X} \to 0$
...
$\det\br{A - \lambda E} = \br{\lambda - a}\br{\lambda - 1} + 2 = \pow{\lambda}{2} - \br{a + 1} \lambda + a + 2$. Харакетристическое уравнение имеет вид:
$\pow{\lambda}{2} - \br{a + 1} \lambda + a + 2 = 0$. $D = \br{a + 1}^2 - 4\br{a + 2} = \pow{a}{2} - 2a - 7$.
...
$\dfrac {dy} {dx} = \dfrac {xy + x + y} {\pow{x}{2} - x - 2y}$. Это уравнение Дарбу и замена $y = x \cdot t\br{x}$ сведёт его к уравнению Бернулли.
$t + x \dfrac {dt} {dx} = \dfrac {\pow{x}{2}t + x + xt} {\pow{x}{2} - x - 2xt} = \dfrac {xt + 1 + t} {x - 1 - 2t}$.
$x \dfrac {dt} {dx} = \dfrac {x} {x\'\br{t}} = \dfrac {xt + 1 + t} {x - 1 - 2t} - t = \linebreak = \dfrac {1 + 2t + 2\pow{t}{2}} {x - 1 - 2t}$.
$x\'\br{t} + \dfrac {1 + 2t} {2\pow{t}{2} + 2t + 1} x\br{t} = \dfrac {1} {2\pow{t}{2} + 2t + 1} \pow{x}{2}\br{t}$. $x\br{t} = \dfrac {1} {C \sqrt{2\pow{t}{2} + 2t + 1} - 2t - 1}$ и общее решение (уравнение траекторий) можно записать по крайней мере в параметрической форме:
\begin{align*}
x\br{t} = \dfrac {1} {C \sqrt{2\pow{t}{2} + 2t + 1} - 2t - 1} && y\br{t} = \dfrac {t} {C \sqrt{2\pow{t}{2} + 2t + 1} - 2t - 1}
\end{align*}
...
Поступим аналогично. Уравнение траекторий $\dfrac {dy} {dx} = \dfrac {xy + x + y} {\pow{x}{2} - 2x - 2y}$ снова представляет собой уравнение Дарбу. $y\br{x} = x \cdot t\br{x}$.
