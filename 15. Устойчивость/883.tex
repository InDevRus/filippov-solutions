...
\begin{align*}
\br{X\br{t} - \Phi\br{t}}^2 = \pow{A}{2} e^{2t} + \pow{B}{2} e^{4t} &&
\br{X\br{t_{0}} - \Phi\br{t_{0}}}^2 = \pow{A}{2} + \pow{B}{2}
\end{align*}

Для $\epsilon = 1$ и любого $\delta > 0$ потребуем, чтобы $A$ и $B$ были таковы, что $0 < \pow{A}{2} + \pow{B}{2} < \pow{\delta}{2}$. Обе функции $e^{2t}$ и $e^{4t}$ возрастают, то есть при $t \ge t_{0} = 0$ будет $e^{4t} \ge e^{2t}$. Однако, при
$t \ge \max\br{ \dfrac {1} {2} \ln\br{\dfrac {1}{\pow{A}{2} + \pow{B}{2}}}; 0}$ имеем
$\pow{A}{2} e^{2t} + \pow{B}{2} e^{4t} \ge e^{2t} \br{\pow{A}{2} + \pow{B}{2}} \ge 1 = \pow{\epsilon}{2}$, и поэтому \linebreak решение неустойчиво.
