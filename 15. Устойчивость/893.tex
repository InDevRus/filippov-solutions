...
$\dfrac {d} {dt} \br{ x \pow{e}{- A\br{t}}} = 0$. $x\br{t} = C \pow{e}{A\br{t}}$ -- общее решение.
...
Пусть $\epsilon = 1$, $\delta > 0$ -- произвольное и $\vbr{x\br{0} - \phi\br{0}} = \vbr{C} < \delta$, $\vbr{C} \ne 0$. $A\br{t}$ неограничена, значит найдётся такое $t_{1} > 0$, что $A\br{t_{1}} \ge \ln\br{\dfrac {\epsilon} {\vbr{C}}}$. В таком случае $\vbr{x\br{t_{1}} - \phi\br{t_{1}}} = \linebreak = \vbr{C} \pow{e}{A\br{t_{1}}} \ge \epsilon$.
...
$$\vbr{x\br{t} - \phi\br{t}} = \vbr{C} \pow{e}{A\br{t}} < \delta \pow{e}{\alpha} = \epsilon.$$
