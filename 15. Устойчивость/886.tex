...
\begin{align*}
    ...
    && \vbr{X\br{t_0} - \Phi\br{t_0}} = \sqrt{\pow{x}{2}\br{0} + \pow{y}{2}\br{0}}.
\end{align*}

Пусть $\sqrt{\pow{x}{2}\br{0} + \pow{y}{2}\br{0}} < \delta$. Тогда $\delta > \sqrt{\pow{x}{2}\br{0} + \pow{y}{2}\br{0}} \ge \rho_{\min}\br{C} = \sqrt{2C}$ и $C < \dfrac {\pow{\delta}{2}} {2}$.
