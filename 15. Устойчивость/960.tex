...
Уравнение и факт устойчивости эффективно зависят только от $ab$, так что для удобства переобозначим $ab = \gamma$. Исследовать будем уравнение $f\br{\rho} = \rho^2 - \br{\gamma + 2}\rho + 1 = 0$.
