...
Матрица монодромии $C$ такова, что $X\br{t + 2} = X\br{t} C$ для всех $t$. В частности, $X\br{1} = \linebreak = X\br{-1} C$ и $C = \br{X\br{-1}}^{-1} X\br{1}$.
\begin{align*}
...
$$\det\br{C - \rho E} = \br{\rho - 1}\br{\rho - ab - 1} - ab = \rh\pow{o}{2} - \br{ab + 2}\rho + 1 = 0.$$
...
Уравнение и факт устойчивости эффективно зависят только от $ab$, так что для удобства переобозначим $ab = \gamma$. Исследовать будем уравнение $f\br{\rho} = \rh\pow{o}{2} - \br{\gamma + 2}\rho + 1 = 0$.
...
\begin{enumerate}
    ...
    \begin{align*}
        \rho_{1, 2} = \dfrac {\gamma + 2 \mp \sqrt{-\gamma \br{\gamma + 4}} i} {2};
        && \vbr{\rho_{1}} = \vbr{\rho_{2}} =
        \sqrt{\dfrac {\br{\gamma + 2}^2 - \gamma \br{\gamma + 4}} {4}} = 1.
    \end{align*}
