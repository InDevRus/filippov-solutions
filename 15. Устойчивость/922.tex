...
\begin{itemize}
    \item $-\sin \br{v + \pi n} = - \br{-1}^{n} \sin v = - \br{-1}^{n} \br{v + o\br{v}} = - \br{-1}^{n} v + o\br{\sqrt{\pow{u}{2} + \pow{v}{2}}}$;
...
Если $n$ чётное, то $4\pow{\lambda}{2} + \lambda + 5 = 0$. $D = -79$. $\Re\br{\lambda} = -\dfrac {1} {8}$, потому положение устойчиво.

В случае, когда $n$ нечётное, получаем $4\pow{\lambda}{2} - \lambda - 5 = 0$. $D = 81$. $\lambda_{1} = -1$, $\lambda_{2} = \dfrac {5} {4}$. Положение неустойчиво.
