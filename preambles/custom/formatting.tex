...
\AtBeginDocument{
    ...
    \renewmathcommand{\prime}{\hspace{0.06em}\char"2032\hspace{-0.03em}}
    % Сокращение предыдущего, которое может давать сбой внутри
    % некоторых окружений (например, в \begin{framed})
    \renewmathcommand{\'}{\prime}
    % Знак прим с нижним индексом
    \newmathcommand{\primesub}[3][1]{\subpow{#2\mathrlap{\multido{}{#1}{\prime}}}{#3}{\hphantom{\displaystyle\multido{}{#1}{\prime}}}}

    \newmathcommand{\f}{\hspace{0.075em}f\hspace{-0.075em}}
    \renewmathcommand{\j}{\hspace{0.15em}j}
    \newmathcommand{\x}{\hspace{0.05em} x}
    \newmathcommand{\X}{\hspace{0.075em}X\hspace{-0.075em}}
