...
\AtBeginDocument{
    ...
    \renewmathcommand{\prime}{\char"2032}
    \newmathcommand{\lprime}{\raisebox{-0.15em}{$\prime$}}
    % Знаки выше с корректировкой отступов для "хвостатых" букв, таких как f.
    \newmathcommand{\corprime}{\hspace{0.05em}\prime\hspace{-0.05em}}
    \newmathcommand{\corlprime}{\hspace{0.05em}\lprime\hspace{-0.05em}}
    ...
    \newmathcommand{\primesub}[3][1]{
        \mathrlap{\hphantom{#2}\multido{}{#1}{\corprime\kern-0.06em}\kern-0.06em}
        \subpow{#2}{#3}{\hphantom{\displaystyle\multido{}{#1}{\corprime\kern-0.06em}}\kern-0.06em}
    }
