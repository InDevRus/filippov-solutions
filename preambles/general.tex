...
\newcommand{\tintlim}[2]{\displaystyle{\mathlarger{\int}\displaylimits_{#1}^{#2}}}
...
\newcommand{\tmin}[1]{\displaystyle{\min_{\mathsmaller{#1}}}}
\newcommand{\tmax}[1]{\displaystyle{\max_{\mathsmaller{#1}}}}
\newcommand{\tlim}[1]{\displaystyle{\lim_{\mathsmaller{#1}}}}
