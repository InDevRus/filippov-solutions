...
$z\'\br{t} = \tpow{10}{\hspace{0.5mm}x + z}$.
$\tpow{10}{-z} \cdot z\' = \tpow{10}{\hspace{0.5mm}x}$.
\vspace{1mm}
Взяв интеграл левой и правой частей по $dx$, получаем $-\dfrac {\tpow{10}{-z}}{\ln 10} = \dfrac{\tpow{10}{\hspace{0.5mm}x}} {\ln 10} + C$.

Окончательно, общее решение равняется
$z\br{x} = -\lg\br{C - \tpow{10}{\hspace{0.5mm}x}}$, где
