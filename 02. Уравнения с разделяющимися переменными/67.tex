...
$\tint \dfrac {3\pow{y}{2} y\'} {\pow{y}{3} - 8} dx
= \tint \dfrac {3\pow{y}{2} dy}{\pow{y}{3} - 8}
= \tint \dfrac {1} {\pow{y}{3} - 8} d\br{\pow{y}{3}}
= \ln\vbr{\pow{y}{3} - 8} + C$. \vspace{1mm}
...
$\Big($например, при $x > \sqrt{\max\br{0; -\ln\vbr{C}}}$$\Big)$ имеем $\vbr{C \tpow{e}{\pow{x}{2}}} > 1$, а потому
$\vbr{y\br{x}}
= 2{\sqrt[3]{\vbr{C \tpow{e}{\pow{x}{2}} + 1}}}
\ge 2{\sqrt[3]{\vbr{\vbr{C \tpow{e}{\pow{x}{2}}} - 1}}}
= 2{\sqrt[3]{\vbr{C} \tpow{e}{\pow{x}{2}} - 1}} > \linebreak
> 2{\sqrt[3]{\vbr{C} \tpow{e}{\pow{x}{2}}}}
= 2 \sqrt[3]{\vbr{C}} \exp\br{\dfrac {1} {3} \pow{x}{2}} = g\br{x}$.
