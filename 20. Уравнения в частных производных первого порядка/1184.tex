...
\begin{document}
    ...
    $\dvfrac {\d x} {x + z} = \dvfrac {\d y} {y + z} = \dvfrac {\d z} {x  + y}$.
    ...
    \begin{enumerate}
        ...
        Таким образом,
        $\dfrac {\d x + \d y + \d z} {2\br{x + y + z}} = \dvfrac {\d x - \d y} {x - y}$.
