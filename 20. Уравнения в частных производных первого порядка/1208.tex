...
\begin{document}
    ...
    и
    $\dfrac {\d y} {y - z} = \dfrac {\d z} {2z}$. Они равносильны, так что достаточно решить только одну. К ним также можно добавить функцию $z\br{x; y} = 0$, хотя это решение и не подходит под условие задачи.

    Решим, например, первую.
    $\dfrac {\d x} {\d z} = \dfrac {1} {2z} x\br{z} - \dfrac {1} {2}$.
    ...
    \begin{itemize}
        ...
        $\dfrac {1} {\sqrt{z}} \dfrac {\d x} {\d z} - \dfrac {1} {2\sqrt{\pow{z}{3}}} x = -\dfrac {1} {2 \sqrt{z}}$.
        $\dfrac {d} {\d z} \br{\dfrac {1} {\sqrt{z}} \cdot x} = -\dfrac {1} {2 \sqrt{z}}$.
        $\dfrac {x} {\sqrt{z}} = -\sqrt{z} + A_{1}$.
        $\dfrac {x + z} {\sqrt{z}} = A_{1}$.

        \item В области $z < 0$ замена переменных $- z = \zeta > 0$, $\dfrac {\d x} {\d z} = -\dfrac {\d x} {d\zeta}$
        приводит к уравнению
        $\dfrac {\d x} {d\zeta} - \dfrac {1} {2\zeta} x\br{\zeta} = \dfrac {1} {2}$,
