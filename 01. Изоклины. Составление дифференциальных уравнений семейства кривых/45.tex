...
$r = a \pow{\cos}{2}\theta$.
$a = \dfrac {r} {\pow{\cos}{2} \theta}$.
$0 = \dfrac {r\' \pow{\cos}{2} \theta + 2r \sin\theta \cos\theta} {\pow{\cos}{4} \theta}$.
$r\' = -2r \tg\theta = A_{y}$.
Таким образом, уравнение изогональных (ортогональных) траекторий в обозначениях, указанных выше, принимает форму
$\dfrac {d\rho} {d\theta} = A_{z} = -\dfrac {\rh\pow{o}{2}} {A_{y}} = \dfrac {\rh\pow{o}{2}} {2\rho \tg\theta}.$
