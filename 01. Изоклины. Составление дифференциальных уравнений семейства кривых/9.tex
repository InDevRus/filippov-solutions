...
$y\br{x} = \dfrac {1} {2} \pow{x}{2} - \ln\ \br{\tintlim{0}{x} \pow{e}{\elevate{\frac {1}{2} \pow{t}{2}}} dt + C}
= \dfrac {1} {2} \pow{x}{2} - \ln\ \br{\sqrt{\dfrac {\pi}{2}} \erfi\br{\dfrac {x} {\sqrt{2}}} + C}$,
где $\erfi\br{x} = \sqrt{\dfrac {2} {\pi}} \tintlim{0}{x} \tpow{e}{\pow{t}{2}} dt$ -- мнимая функция ошибок.
\end{remark} 
