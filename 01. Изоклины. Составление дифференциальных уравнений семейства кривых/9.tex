...
$f\br{x; y} = x - \pow{e}{y}$. Уравнение изоклины: $x - \pow{e}{y} = k$. $y\br{x} = \ln\br{x - k}$, где $x > k$, либо $x\br{\y} = k + \pow{e}{y}$. Таким образом, изоклинами будут логарифмические кривые. На левом рисунке изображены изоклины, на правом -- решения уравнений.
...
\begin{remark} Кривые на рисунке справа построены  по общему решению исходного уравнения, равному
$y\br{x} = \dfrac {1} {2} \pow{x}{2} - \ln\ \br{\tintlim{0}{x} \pow{e}{\elevate{\frac {1}{2} \pow{t}{2}}} \di t + C}
= \dfrac {1} {2} \pow{x}{2} - \ln\ \br{\sqrt{\dfrac {\pi}{2}} \erfi\br{\dfrac {x} {\sqrt{2}}} + C}$,
где $\erfi\br{x} = \sqrt{\dfrac {2} {\pi}} \tintlim{0}{x} \tpow{e}{\pow{t}{2}} \di t$ -- мнимая функция ошибок.
\end{remark} 
