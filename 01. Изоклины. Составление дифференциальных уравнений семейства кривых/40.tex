...
Таким образом, имеем два уравнения изогональных траекторий вида $\zed'\br{x} = f\br{x; \zed\br{x}}$ и $\zed'\br{x} = g\br{x; \zed\br{x}}$. Более конкретно, $\zed' = \dfrac {\zed - x} {\zed + x}$ и $\zed' = - \dfrac {\zed + x} {\zed - x}$.
