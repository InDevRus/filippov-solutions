...
Итак, $f\br{x; y} = \dfrac {1} {2} x - y + \dfrac {3} {2}$.
Уравнение изоклины: $\dfrac {1} {2} x - y + \dfrac {3} {2} = k$. 
$y = \dfrac {1} {2} x + \dfrac {3} {2} - k$. 
Таким образом, изоклинами будут прямые. 
На левом рисунке изображены изоклины, на правом -- решения уравнений.

В частности, из построенных изоклин видно, что среди решений присутствует прямая
$\sub{y}{0} = \dfrac {1} {2} x  + 1$. 
Действительно, всякая изоклина -- это прямая с угловым коэффициентом 
$\dfrac {1} {2}$, так что, если положить $y\`\br{x} = f\br{x; y} = k$
равной также $\dfrac {1} {2}$,
то получится прямая $\sub{y}{0} = \dfrac {1} {2} x  + 1$.
...
\begin{remark} 
    ...
    которое имеет вид $y\br{x} = C\pow{e}{-x} + \dfrac {x} {2} + 1$.
\end{remark}
