...
В частности, из построенных изоклин видно, что среди решений есть прямая $\sub{y}{0} = \linebreak = \dfrac {1} {2} x  + 1$. Действительно, всякая изоклина -- это прямая с угловым коэффициентом $\dfrac {1} {2}$, так что, если положить $y\`\br{x} = f\br{x; y} = k$ равной также $\dfrac {1} {2}$, то получится прямая $\sub{y}{0} = \dfrac {1} {2} x  + 1$.
...
\begin{remark} Кривые на рисунке справа построены  по общему решению исходного  уравнения, которое имеет вид $y\br{x} = C\tpow{e}{-x} + \dfrac {x} {2} + 1$.
\end{remark}
