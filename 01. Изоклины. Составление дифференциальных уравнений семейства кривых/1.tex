...
$f\br{x; y} = y - \pow{x}{2}$.
Уравнение изоклины: $y - \pow{x}{2} = k$. $y = k + \pow{x}{2}$.
Построим достаточное количество парабол для различных значений $k$. 
...
\begin{remark} 
    ...
    которое имеет вид $y\br{x} = C\pow{e}{x} + \pow{x}{2} + 2x + 2$.
\end{remark}
