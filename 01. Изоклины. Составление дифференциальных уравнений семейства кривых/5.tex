...
\begin{remark} Кривые на рисунке справа построены по общему решению исходного  уравнения, которое имеет вид $y\br{x} = \sqrt{\pow{C}{2} - \pow{x}{2}}$, $y\br{x} = -\sqrt{\pow{C}{2} - \pow{x}{2}}$.
\end{remark}
