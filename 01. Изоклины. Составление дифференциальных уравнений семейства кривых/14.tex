...
Имеем уравнение $y\' = \dfrac {4x} {\pow{x}{2} + \pow{y}{2}}$. Для удобства дальнейших построений рассмотрим уравнение над обратной функцией $x\br{y}$, используя правило производной обратной функции: $x\'\br{y} = \dfrac {\pow{x}{2} + \pow{y}{2}} {4x}$.

При такой постановке задачи имеем уравнение изоклины: $\dfrac {\pow{x}{2} + \pow{y}{2}} {4x} = m$, где $m = \dfrac {dx} {dy} \linebreak = \dfrac {1} {k} \ne 0$.
$\pow{x}{2} - 4mx + \pow{y}{2} = 0$, $\br{\pow{x}{2} - 4mx + 4\pow{m}{2}} + \pow{y}{2} = 4\pow{m}{2}$.
$\br{x - 2m}^2 + \pow{y}{2} = \br{2m}^2$, так что изоклинами будут окружности с центром $\br{2m; 0}$ и радиусом $\vbr{2m} > 0$.
...
\begin{remark} Кривые на рисунке справа построены \vspace{1mm} по общему решению исходного уравнения, которое имеет неявную форму $\pow{x}{2} + \br{y + 2}^2 = C\tpow{e}{\elevate{\frac {y}{2}}} - 4$.
\end{remark} 
