...
При такой постановке задачи имеем уравнение изоклины: $\dfrac {\pow{x}{2} + \pow{y}{2}} {4x} = m$, где $m = \dvfrac{x}{y} \linebreak = \dfrac {1} {k} \ne 0$.
...
\begin{remark} Кривые на рисунке справа построены  по общему решению исходного уравнения, которое имеет неявную форму $\pow{x}{2} + \br{y + 2}^2 = C\tpow{e}{\elevate{\frac {y}{2}}} - 4$.
\end{remark} 
