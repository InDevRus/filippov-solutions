...
Таким образом, уравнение изогональных (ортогональных) траекторий в 
обозначениях, указанных выше, принимает форму
$\der{\rho}{\theta} 
= \sub{A}{z} = \linebreak 
= -\dfrac {\pow{\rho}{2}} {\sub{A}{y}} 
= \dfrac {\pow{\rho}{2}} {\sin\theta}.$
$\sin\theta\ \rho\`\br{\theta} = \pow{\rho}{2}\br{\theta}$.

\begin{remark}
    Уравнение
    $\rho\` = \dfrac {\pow{\rho}{2}} {\sin\theta}$
    имеет общее решение
