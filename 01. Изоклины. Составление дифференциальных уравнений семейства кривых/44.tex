...
\begin{framed}
	...
	\begin{align*}
		...
		&&
		B_{\zed}\br{\rho; \theta} = -\dfrac {1} {B_{y}\br{r; \theta}};
		&&
	...
	$$A_{\zed}\br{\rho; \theta} = -\dfrac {\rho^2} {A_{y}\br{r; \theta}}.$$
\end{framed}
...
$\dfrac {d\rho} {d\theta} = A_{\zed} = \linebreak = -\dfrac {\rho^2} {A_{y}} = \dfrac {\rho^2} {\sin\theta}.$
$\sin\theta\ \rho'\br{\theta} = \rho^2\br{\theta}$.

\begin{remark}
	Уравнение
	$\rho' = \dfrac {\rho^2} {\sin\theta}$
	имеет общее решение
	$$\rho = \dfrac {1} {C - \ln\br{\tg\dfrac {\theta} {2}}}.$$
\end{remark}
