...
\item $y\' = y - \pow{x}{2}$.
$y\'\'\br{x} = \dfrac {d} {dx} \br{y - \pow{x}{2}} = y\' - 2x = y - x^{2} - 2x$. \\
...
= -e^y - \pow{x}{2} e^y + 3 x e^{2y} - 2 e^{3y}$.
...
$y\' = y^{-2} \br{1 - \pow{x}{2}} = y^{-2} - \pow{x}{2} y^{-2}$. \\
$y\'\'\br{x} = -2 y^{-3} y\' + 2 \pow{x}{2} y^{-3} y\' - 2x y^{-2}
= -2y^{-3} y\' \br{1 - \pow{x}{2}} - 2x y^{-2}
= -2y^{-5} \br{1 - \pow{x}{2}}^2 - 2x y^{-2}$. \\
\begin{multline*}
    y\'\'\'\br{x}
    = 10 y^{-6} \br{1 - \pow{x}{2}}^2 y\' + 8 x y^{-5} \br{1 - \pow{x}{2}} - 2y^{-2} + 4xy^{-3} y\' = \\
    = 10 y^{-8} \br{1 - \pow{x}{2}}^3 + 8 x y^{-5} \br{1 - \pow{x}{2}} - 2y^{-2} + 4xy^{-5} \br{1 - \pow{x}{2}} = \\
    = 10 y^{-8} \br{1 - \pow{x}{2}}^3 + 12 xy^{-5} \br{1 - \pow{x}{2}} - 2y^{-2}.
\end{multline*}
Пусть $y\'\'\br{x} = -2y^{-5} \br{1 - \pow{x}{2}}^2 - 2x y^{-2} = 0$, то есть $\br{1 - \pow{x}{2}}^2 = -x\pow{y}{3}$.
\begin{multline*}
    y\'\'\'\br{x}
    = 10 y^{-8} \br{1 - \pow{x}{2}} \cdot \br{-x\pow{y}{3}} + 12 xy^{-5} \br{1 - \pow{x}{2}} - 2y^{-2}
    = 2 xy^{-5} \br{1 - \pow{x}{2}} - 2y^{-2} = \\
    = -2 y^{-8} \br{1 - \pow{x}{2}}^2 - 2y^{-2}
    = -2y^{-2} \br{y^{-6} \br{1 - \pow{x}{2}}^2 + 1} < 0.
\end{multline*}
