...
$f\br{x; y} = \dfrac {y} {y + x}$.
Уравнение изоклины: $\dfrac {y} {y + x} = k$. $y\br{x} = \dfrac {k} {1 - k} x$.
...
\begin{remark}
    ...
    исходного уравнения, которое можно задать либо в параметрической форме
    $$\tsys{
        x\br{t} = C f\br{t} \\
        y\br{t} = Ct f\br{t}}\text{, где } f\br{t} = \dfrac {\pow{e}{\selevate{\frac {1} {t}}}} {t},
    $$
    ...
    где $r\br{\phi} = \dfrac { \pow{e}{\selevate{\ctg\phi}}} {\sin\phi}$, то есть
    $\tsys{
        x\br{\phi} = C \ctg\br\phi \pow{e}{\selevate{\ctg\phi}} \vspace{0.1em} \\
        y\br{\phi} = C \,\pow{e}{\selevate{\ctg\phi}}
    }$.
\end{remark} 
