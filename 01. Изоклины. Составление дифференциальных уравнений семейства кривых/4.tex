...
$f\br{x; y} = \dfrac {y - x} {\pow{y}{2} + 1}$. Уравнение изоклины: $\dfrac {y - x} {\pow{y}{2} + 1} = k$, $y - x = k\pow{y}{2} + k$, $x = -k\pow{y}{2} + y + -k$. Изоклинами будут параболы вида $x = x\br{\y}$ (кроме случая $k = 0$, который задаёт прямую $x = y$).
