...
$f\br{x; y} = \dfrac {1} {2} \br{\pow{x}{2} + \pow{y}{2}} - 1$.
Уравнение изоклины: 
$\dfrac {1} {2} \br{\pow{x}{2} + \pow{y}{2}} - 1 = k$.
$\pow{x}{2} + \pow{y}{2} = 2\br{k + 1}$, причём $k \ge -1$. 
Таким образом, изоклинами будут окружности радиуса $\sqrt{2\br{k + 1}}$.
На левом рисунке изображены изоклины, на правом -- приближённые решения уравнений.
...
\begin{remark} 
    Кривые на рисунке справа построены по приближениям Пикара 
    на четвёртой итерации. Из-за погрешностей построенные кривые
    не везде имеют касательную, совпадающую с обозначенной на изоклине. 
\end{remark}
