...
\begin{framed}
    ...
    \begin{align*}
        \sub{A}{z}\br{\rho; \theta}
        = \rho \cdot \dfrac {\sub{B}{z}\br{\rho; \theta} \sin\theta + \cos\theta} {\sub{B}{z}\br{\rho; \theta} \cos\theta - \sin\theta};
        &&
        \sub{B}{z}\br{\rho; \theta} = \dfrac {\sub{B}{y}\br{\rho; \theta} \pm 1} {1 \mp \sub{B}{y}\br{\rho; \theta}};
    \end{align*}
    $$\sub{B}{y}\br{r; \theta} = \dfrac {\sub{A}{y}\br{r; \theta} \sin\theta + r \cos\theta} {\sub{A}{y}\br{r; \theta} \cos\theta - r \sin\theta},$$
    ...
    \begin{align*}
        \sub{A}{z}\br{\rho; \theta} = \rho \cdot \dfrac {\sub{A}{y}\br{\rho; \theta} - \rho} {\sub{A}{y}\br{\rho; \theta} + \rho} &&
        \sub{A}{z}\br{\rho; \theta} = -\rho \cdot \dfrac {\sub{A}{y}\br{\rho; \theta} + \rho} {\sub{A}{y}\br{\rho; \theta} - \rho}
    \end{align*}
\end{framed}
