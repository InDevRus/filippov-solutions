...
\begin{framed}
    ...
    \begin{align*}
        A_{z}\br{\rho; \theta}
        = \rho \cdot \dfrac {B_{z}\br{\rho; \theta} \sin\theta + \cos\theta} {B_{z}\br{\rho; \theta} \cos\theta - \sin\theta};
        &&
        B_{z}\br{\rho; \theta} = \dfrac {B_{y}\br{\rho; \theta} \pm 1} {1 \mp B_{y}\br{\rho; \theta}};
    \end{align*}
    ...
    \begin{align*}
        A_{z}\br{\rho; \theta} = \rho \cdot \dfrac {A_{y}\br{\rho; \theta} - \rho} {A_{y}\br{\rho; \theta} + \rho} &&
        A_{z}\br{\rho; \theta} = -\rho \cdot \dfrac {A_{y}\br{\rho; \theta} + \rho} {A_{y}\br{\rho; \theta} - \rho}
    \end{align*}
\end{framed}
...
$r = a \sin\theta$.
$a = \dfrac {r} {\sin\theta}$.
$0 = \dfrac {r\' \sin\theta - r\cos\theta} {\pow{\sin}{2} \theta}$.
