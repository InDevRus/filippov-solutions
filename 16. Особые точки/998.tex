...
Если особая точка уравнения $\br{ax + by} \d x + \br{mx + ny} \d y = 0$ является <<центром>>, 
то корни соответствующего характеристического уравнения чисто мнимы.

Не считая тех областей, где $mx + ny = 0$, $\dfrac {\d y} {\d x} = \dfrac {-ax - by} {mx + ny}$.
...
$\br{ax + by} \d x + \br{bx + ny} \d y = 0$. $P\br{x; y} = ax + by$, $Q\br{x; y} = bx + ny$ 
и $\parder{Q}{x} - \parder{P}{y} = b - b = 0$ 
и данное уравнение -- это уравнение в полных дифференциалах, и его общее решение
...
то уравнение примет вид $a \d x + b \d y = 0$, и начало координат вообще не будет
особой точкой.
