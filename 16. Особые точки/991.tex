...
\begin{framed}
    ...
    При $r\br{\xi; \phi} = \sqrt{\pow{\xi}{2} + \pow{\phi}{2}} \to 0$ имеем $\xi \phi = O\br{\pow{r}{2}}$. В частности, $\dfrac{\xi \phi} {r^{1 + \epsilon}} = \dfrac {\gamma\br{r} \pow{r}{2}} {r^{1 + \epsilon}} \to 0$ для всех $\epsilon \in \br{0; 1}$.
