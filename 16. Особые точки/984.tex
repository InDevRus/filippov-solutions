...
\begin{enumerate}
    ...
    $\dfrac {d\phi} {\d x} = \linebreak = \dfrac {\phi} {x + \phi}$.
    ...
    $\dfrac {d\phi} {\d \xi} = \dfrac {\phi + \sqrt{9 + 2\pow{\xi}{2} + 8\xi} - 3}
    {\xi + \phi}$.
    ...
    $\dfrac {d\phi} {\d \xi} = \dfrac {\dfrac {4} {3} \xi + \phi} {\xi + \phi}$.
    $A = \begin{pmatrix} 1 & 1 \\ \frac {4} {3} & 1 \end{pmatrix}$. \\
    $\det\br{A - \lambda E} = \dfrac {1} {3} \br{3\pow{\lambda}{2} - 6\lambda - 1}$.
    $\sub{\lambda}{1} = \dfrac {3 - 2\sqrt{3}} {3}$,
    $\sub{\lambda}{2} = \dfrac {3 + 2\sqrt{3}} {3}$, и особая точка $\sub{A}{2}\br{2; -3}$
     -- <<седло>>.
